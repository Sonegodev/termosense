...
class _DetalhesSalaState extends State<DetalhesSala> {
  ...
  String formatarHorario(DateTime horario) {
    final formato = DateFormat('dd/MM/yyyy HH:mm'); // Formato desejado
    return formato.format(horario);
  }
    ...
    return MultiProvider(
      ...
      child: Scaffold(
        ...
        body: Consumer3<TemperaturaProvider, FuncionarioProvider,
            UsuarioAmbienteProvider>(builder: (context, temperaturaProvider, funcionarioProvider, usuarioAmbienteProvider, child) {
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        setState(() {
                          temperaturaAtual = (temperaturaAtual ?? detalhes.temperaturaAlterada) - 1;
                        });
                      },
                ...
                Text('Data: ${formatarHorario(detalhes.horarioMudanca)}'),
